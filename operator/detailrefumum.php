			  ...
			  <tbody>
				...
				<tr>
				  <td width="30%"></td>
					...
					<a onclick="return confirm ('Yakin Mau Menghapus');"  href="?p=deleterefumum&id=<?php echo $data['id_reg'];?>" class="btn btn-danger  " role="button" aria-disabled="true"><span data-feather="trash"></span>Delete</a>
					...
					<a href="?p=editrefumum&id=<?php echo $data['id_reg']; ?>" class="btn btn-warning " role="button" aria-disabled="true"><span data-feather="edit"></span>Edit</a>
