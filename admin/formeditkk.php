		...
		<form action="?p=editkk&id=<?php echo $data['id_reg_kkktp']; ?>" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="">
			  <div class="form-group row">
			   ...
			   <div class="form-group row">
				...
				<div class="col-sm-10">
				  <input type="text" class="form-control" id="tanggal_reg" name="tanggal_reg" value="<?php echo $data['tanggal_reg']; ?>">
				</div>
			  </div>
			  <div class="form-group row">
			...
			<div class="form-group row">
			   ...
			   <div class="form-group row">
				...
				<div class="col-sm-10">
				  <input type="text" class="form-control" id="tanggal_lahir_kkktp" name="tanggal_lahir_kkktp" value="<?php echo $data['tanggal_lahir_kkktp']; ?>">
				</div>
			  </div>
