        ...
        <nav class="col-md-2 d-none d-md-block bg-white sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?p=pelayanan_umum">
                  <span data-feather="file"></span>
                  Pelayanan Umum
                </a>
              </li>
			  <li class="nav-item">
                <a class="nav-link" href="?p=pindah_datang">
                  <span data-feather="activity"></span>
                  Reg Pindah Datang
                </a>
              </li>
			  <li class="nav-item">
                <a class="nav-link" href="?p=pelayanan_ktpkk">
                  <span data-feather="credit-card"></span>
                  Reg KK KTP
                </a>
              </li>
			 <li class="nav-item">
                <a class="nav-link" href="?p=refpegawai">
                  <span data-feather="users"></span>
                  Data Pegawai
                </a>
              </li>
			  <li class="nav-item">
                <a class="nav-link" href="?p=refuser">
                  <span data-feather="user"></span>
                  Ref User
                </a>
              </li>
			  <li class="nav-item">
                <a class="nav-link" href="?p=refpriode">
